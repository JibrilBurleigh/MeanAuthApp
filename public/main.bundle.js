...
module.exports = "<div class=\"jumbotron  text-center\">\n    <h1>MEAN Authentication App</h1>\n    <p class=\"lead\">Welcome to our custom MEAN authentication application built from strach</p>\n    <div>\n      <a class=\"btn btn-primary\" [routerLink]=\"['/register']\">Register</a> \n      <a class=\"btn btn-info\" [routerLink]=\"['/login']\">Login</a> \n    </div>\n  </div>\n  \n  <div class=\"row\">\n    <div class=\"col-md-4\">\n      <h3>Express Backend</h3>\n      <p>A rock solid Node.js/Express server using Mongoose to organize models and query data</p>\n    </div>\n    <div class=\"col-md-4\">\n      <h3>Angular-CLI</h3>\n      <p>Angular-CLI to generate components, services and more. Local dev server and easy to manager</p>\n    </div>\n    <div class=\"col-md-4\">\n      <h3>JWT tokens</h3>\n      <p>Full feature authentication using JSON web tokens. Login and store user data</p>\n    </div>"
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.loggedIn = function () {
        console.log(__WEBPACK_IMPORTED_MODULE_3_angular2_jwt__["tokenNotExpired"]);
